    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h3 class="fw-bold mb-0" style="color: #0f172a;">Tambah Lokasi Baru</h3>
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.office-locations.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="office_name" class="form-control rounded-3 @error('office_name') is-invalid @enderror" value="{{ old('office_name') }}" placeholder="Contoh: Kantor Pusat Jakarta" required>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="latitude" class="form-control rounded-3 @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}" placeholder="Contoh: -6.2088" required>
                                @error('latitude') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-muted small fw-semibold">Longitude</label>
                                <input type="text" name="longitude" class="form-control rounded-3 @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}" placeholder="Contoh: 106.8456" required>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group">
                                <input type="number" name="radius_meter" class="form-control rounded-start-3 @error('radius_meter') is-invalid @enderror" value="{{ old('radius_meter', 50) }}" min="1" required>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button type="submit" class="btn btn-primary px-5 rounded-pill shadow-sm">Simpan Lokasi</button>
                        </div>
                    </form>
                </div>
            </div>
